...
const Navbar = () => {
  ...
  return (
    <nav className="bg-blue-800 text-white p-4 sticky top-0 z-50 shadow-lg">
      ...
      {/* Navigation Menu */}
      <ul
        className={`font-bold justify-center md:flex md:space-x-5 md:items-center absolute md:relative top-16 md:top-0 left-0 w-full md:w-auto bg-blue-800 md:bg-transparent transition-transform transform md:translate-x-0 duration-300 ease-in-out ${
